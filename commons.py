...
products = [Product('Refrigerator A', 0.751, 999.90),
            ...
            Product("Notebook D", 0.597, 2999.00),
            Product("Notebook E", 0.300, 1999.00),
            Product("Notebook F", 0.127, 999.00),
            Product("Notebook G", 0.27, 99.00),
            Product("Cell C", 0.97, 199.00),
